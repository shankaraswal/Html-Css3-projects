			...
			if(self.settings.keyNavigation) {
				...
				$(document).keydown(function(e) { //when a key is pressed...					
					...
					keyEvents(e.keyCode, self.settings.customKeyEvents); //run custom keyevents
						var actStep1 = $('.nav .bHome img').hasClass('active');
						var actStep2 = $('.nav .bService img').hasClass('active');
						var actStep3 = $('.nav .bTools img').hasClass('active');
						var actStep4 = $('.nav .bPort img').hasClass('active');
						var actStep5 = $('.nav .bProcess img').hasClass('active');
						if(actStep1){
